...
**Function   : **`model_performance_metrics` will generate model performance metrics such as RMSE and R-squared
...
kable(model_performance_metrics(cahoudta_models, cahoudta_model_names),
      col.names = c("R-Squared", "Root Mean Squared Error", "Number of Coefficients"),
