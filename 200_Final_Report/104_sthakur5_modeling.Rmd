...
Lets try backward BIC search from the full interaction model.
```{r}
cahoudta_int_bckwd_bic_model = step(cahoudta_full_int_model, 
                                    direction = "backward",
                                    k = log(n_tr_rows),
                                    trace = 0)
```
...
cahoudta_models[[3]] = cahoudta_add_bckwd_bic_model
cahoudta_model_names[[3]] = "cahoudta_add_bckwd_bic_model"

cahoudta_models[[4]] = cahoudta_int_bckwd_bic_model
cahoudta_model_names[[4]] = "cahoudta_int_bckwd_bic_model"
