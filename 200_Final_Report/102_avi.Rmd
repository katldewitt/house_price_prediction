...
plot_fitted_resid = function(model, model_name, stitle) {
  plot(fitted(model), resid(model), col = "dodgerblue", pch = 20, cex = 1.5, xlab = "Fitted", ylab = "Residuals", main = "Fitted vs. Residual", sub = paste("Model: ",model_name))
  abline(h = 0, col = "darkorange", lwd = 2)
}

# function to plot qq-plot & qq-line
plot_qq = function(model, model_name) {
  qqnorm(resid(model), col = "dodgerblue", pch = 20, cex = 1.5, main = "Q-Q Plot", sub = paste("Model: ",model_name))
