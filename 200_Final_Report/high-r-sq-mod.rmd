...
mod  = lm(log(median_house_value) ~ longitude + housing_median_age + median_income + pop_per_hh + rooms_per_hh + ocean_proximity, data = cah_trn_data)
#summary(mod)
#vif(mod)
```

```{r}
mod_fix_int = lm (log(median_house_value) ~ (longitude + housing_median_age + median_income + pop_per_hh + rooms_per_hh + ocean_proximity ) ^ 2, 
                  data = cah_trn_data, 
